...
from app.services.cafeteria_exceptions import get_cafeteria_exception_store
from app.services.event_cleaner import clean_events
...
from app.services.hikvision_connector import create_event_source
from app.services.pdf_exporter import build_attendance_pdf, build_cafeteria_pdf
from app.services.report_generator import ReportGenerator
from app.models.reports import AttendanceReport, CafeteriaEmployee, CafeteriaReport
...
async def _load_clean_events(
    ...
    *,
    ...
    from app.edge.sync import load_events_from_store, resolve_site_id, sync_events_from_devices
