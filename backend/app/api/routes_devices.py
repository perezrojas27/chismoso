...
from app.security import ROLES_DEVICES, require_roles
...
async def list_devices(settings: Settings = Depends(get_settings)) -> dict:
    ...
    from app.services.device_discovery import discover_unconfigured_hikvision
    ...
    for item in discovered:
        if item["host"] in configured_hosts:
            continue
        from app.services.device_registry import device_id_from_host
