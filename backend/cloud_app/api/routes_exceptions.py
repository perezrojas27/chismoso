...
from cloud_app.services.cafeteria_exceptions import (
    CafeteriaException,
    CafeteriaExceptionCreate,
    get_cafeteria_exception_store,
)
from shared.services.exceptions import BiometricError
...
async def late_candidates(
    ...
    from cloud_app.api.routes_reports import _load_clean_events
